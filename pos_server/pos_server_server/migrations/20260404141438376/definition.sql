...
--
-- Class BillItem as table bill_items
--
...
CREATE TABLE "pos_orders" (
    ...
    "tipAmount" double precision NOT NULL DEFAULT 0,
    "total" double precision NOT NULL,
    "initialSplitCount" bigint,
    "remainingSplitCount" bigint,
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('pos_server', '20260404141438376', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260404141438376', "timestamp" = now();
